...
class RestauranteDB {
    ...
    function getAutor(){
        if($_REQUEST['action'] == 'autor'){
            $response = array('nombre'=>'Edith Elena Herrera Ramírez', 'carnet'=>'HR103216', 'carrera'=>'Ingeniería en sistemas informáticos', 'foto'=>'http://rest.smycode.com/img/edith.jpg');
